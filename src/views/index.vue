<template>
    <div id="home">
        <header class="w-screen leading-none text-3xl mb-6" ref="header">
            ...
            <span class="title">长夜有星辰的博客</span>
        ...
        <section id="banner" v-show="isBannerShow">
            <div class="bannerInner" ref="bannerInner" data-content="长夜有星辰">长夜有星辰</div>
        ...
        <!-- <footer class="footer">晋ICP备18013488号-1 长夜有星辰 2022</footer> -->
        ...
        (e: any) => {
            if (e.target.id === 'home') {
                ...
                if (e.target.scrollTop !== 0) {
                    header.value.style.backgroundColor = '#1e2732';
